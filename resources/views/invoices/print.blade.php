        ...
        <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow ring-1 ring-slate-200 p-6">
            ...
            <div class="mt-6 grid grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="text-slate-600 text-sm">{{ $invoice->client_email }}</div>
                    <div class="text-slate-600 text-sm">{{ $invoice->client_phone }}</div>
                    <div class="text-slate-600 text-sm">{{ $invoice->client_address }}</div>
                </div>
            </div>
            ...
            <div class="mt-6 flex justify-end">
                <div class="w-64">
                    <div class="flex justify-between py-1"><span class="text-slate-600">Subtotal</span><span>{{ number_format($invoice->subtotal,2) }}</span></div>
                    <div class="flex justify-between py-1"><span class="text-slate-600">Tax</span><span>{{ number_format($invoice->tax,2) }}</span></div>
                    <div class="flex justify-between py-2 border-t mt-2 font-semibold"><span>Total</span><span>{{ number_format($invoice->total,2) }}</span></div>
                </div>
            </div>
