<div class="flex items-center gap-2">
    <a href="{{ route('invoices.print', $row) }}" target="_blank" class="inline-flex items-center px-2 py-1 rounded-lg border border-sky-200 text-sky-700 hover:bg-sky-50">Print</a>
