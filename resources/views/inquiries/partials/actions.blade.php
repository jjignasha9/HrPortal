<div class="flex items-center gap-2">
    <button class="btn-follow inline-flex items-center px-2 py-1 rounded-lg border border-sky-200 text-sky-700 hover:bg-sky-50" data-row='@json($row)'>Follow-Up</button>
